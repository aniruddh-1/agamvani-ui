...
public class AudioPlaybackService extends Service {
    ...
    public void onCreate() {
        ...
        // IMPORTANT: Set audio attributes for proper audio routing on tablets
        // This ensures audio plays through the MUSIC stream (not notification/alarm)
    ...
    public void playUrl(String url) {
        // Create simple MediaItem (metadata will be set via
     ...
     * MediaSessionCompat requires explicit setMetadata() calls (ExoPlayer 2.x
     * pattern)
    ...
    private void updateNotification() {
        // Use startForeground() instead of NotificationManager.notify() to ensure
        // update
